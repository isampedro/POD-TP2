...
public class Query3Test {
    ...
    private static final List<Tree> trees = Arrays.asList(new Tree("a", neigh1, "Gral Wololo"),
            new Tree("luca", neigh1, "Gral Wololo"), new Tree("b", neigh1, "Gral Wololo"),
            new Tree("c", neigh1, "Gral Wololo"), new Tree("d", neigh1, "Gral Wololo"),
            new Tree("e", neigh3, "Av juancito"), new Tree("f", neigh3, "Av juancito2"),
            new Tree("g", neigh3, "Av juancito3"), new Tree("h", neigh2, "Av jusepe"),
